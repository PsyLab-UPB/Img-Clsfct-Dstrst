/**
 * @title RoF_Classification_Session1_online-version
 * @description Session 1 of RoF-Classification-1 Online-version
 * @version 1.1.1
 *
 * @assets assets/
 * @imageDir images
...
export async function run({ assetPaths, input = {}, environment, title, version }) {
  ...
  timeline.push({
    ...
    stimulus: () => {
      return `<iframe class="declaration" src="assets/misc/declaration_de_Prolific_RoF1.html"></iframe>`;
    },
